        ...
        <div class="pt-6 w-full">
            <div class="w-full mx-auto space-y-8 sm:p-8 bg-white rounded-lg shadow-xl">
                ...
                <form class="mx-auto" method="post" action="/users/auth" enctype="multipart/form-data">
                    ...
                    <button class="text-white mt-2 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Sign in</button>
                    <div class="mt-6">
