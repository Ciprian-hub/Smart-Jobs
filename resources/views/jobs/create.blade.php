        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
            ...
            <div class="mx-auto">
                <div class="w-full mx-auto lg:max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow-xl">
                    ...
                    <form class="mx-auto" method="POST" action="/jobs" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <input type="text" name="salary" id="salary" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" "
                                   value="{{old('salary')}}"/>
                            @error('salary')
                            <p class="text-sm text-red-900">{{$message}}</p>
                            @enderror
