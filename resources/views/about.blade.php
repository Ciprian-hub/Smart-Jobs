...
@section('content')
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-gray-50  border border-gray-200  rounded-lg p-8 md:p-12">
                    <a href="#" class="bg-green-100 text-green-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded-md  dark:text-green-400 mb-2">
                ...
                <div class="bg-gray-50  border border-gray-200  rounded-lg p-8 md:p-12">
                    <a href="#" class="bg-purple-100 text-purple-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded-md  dark:text-purple-400 mb-2">
    ...
    {{--    <div>--}}
{{--        <div class="flex flex-col gap-3 justify-between mx-auto max-w-4xl mt-16">--}}
{{--            <h2 class="font-bold text-3xl text-gray-800">--}}
{{--                Empowering the world with SmartJobs.--}}
{{--            </h2>--}}
